...
The parameter sets sampled from MCMC $(\epsilon_{\rm MCMC}$ and $\sigma_{\rm MCMC})$ provide an estimate of the uncertainty in $\epsilon$ and $\sigma$ (see Figures \ref{fig:MCMC_Mie_14_15_16_17_18_ethane} and \ref{fig:MCMC_Mie_14_16_propane_butane_octane} in Section \ref{Results}). This parameter uncertainty propagates when estimating another quantity of interest $(QoI)$, which may or may not be included in $D$, according to:
\begin{equation} \label{Posterior Prediction}
...
\begin{figure}[htb!]
	\centering
	\includegraphics[width=6.4in]{MCMC_Mie_14_15_16_17_18_ethane}
