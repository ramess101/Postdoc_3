...
\begin{table}[h!]
	\caption{Equilibrium bond angles $(\theta_0)$.\cite{Martin1999} CH$_i$ and CH$_j$ are CH$_3$, CH$_2$, CH, or C sites.} \label{tab:angles}
...
\begin{table}[h!]
	\caption{Fourier constants $(c_n/k_{\rm B})$ in units of K.\cite{Martin1999} CH$_i$ and CH$_j$ are CH$_3$, CH$_2$, CH, or C sites.} \label{tab:torsions}
	\begin{center}
