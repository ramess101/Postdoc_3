...
\end{equation}
%MRS4: should more explicitly specify what x and y can be in the above deriviatives more explicitly. I mean it's T and P, but make that explicit. 
...
%MRS4: is this really a limitation?  The 2nd part of this paragraph says it doesn't matter in this case, so perhaps better to discuss it in terms how in OTHER cases, a hierarchical model might be neeed.
