...
%MRS5: tweaked to remove colloquialism.
%That being said,
However, 
...
%MRS5: Tweaked to remove colloquialism.  Also, add citation?
...
%MRS5: not quite true; you could have one large and N-1 very small weights, and it would be bad.  Suggested text, may be a bit off, edit as you see fit. Also, reader might not know what 'MBAR weight'' means
...
%MRS5: do you want to define departure internal energy briefly here to avoid issues with the reviewer?
...
%MRS5: suggest instead of ``MCMC sampled parameter sets'' saying something like ``Probability distribution of parameter sets sampled by MCMC'', i.e. what the meaning is.  
...
%MRS5: this section seems somewhat unmovtivated from the rest of the study.  Consider removing or connecting it more stronglyto what came before?  It kind of comes around to it at the end, but is not well motivated at the beginning.
...
\end{equation}
%MRS5: should more explicitly specify what x and y can be in the above deriviatives more explicitly. I mean it's T and P, but make that explicit. 
...
%MRS5: can you draw conclusions on these properties based on findings in the paper?

%MRS5: is this really a limitation?  The 2nd part of this paragraph says it doesn't matter in this case, so perhaps better to discuss it in terms how in OTHER cases, a hierarchical model might be neeed.
...
%MRS5: I still wonder how much this paragraph is needed; to some extent, it's speculation that isn't really necessary for this paper.
...
%MRS5: tweak to remove colloquialism
%That being said,
However, 
...
%MRS5: did something get cut off here?
%
